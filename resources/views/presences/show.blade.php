                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $presence->id }}</td>
                                    </tr>
                                    <tr><th> Schedule Id </th><td> {{ $presence->schedule_id }} </td></tr><tr><th> Student Id </th><td> {{ $presence->student_id }} </td></tr><tr><th> Note </th><td> {{ $presence->note }} </td></tr>
                                </tbody>
                            </table>
                        </div>
